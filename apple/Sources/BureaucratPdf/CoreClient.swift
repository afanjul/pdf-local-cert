...
/// Talks to the bundled `bureaucratpdf-core` sidecar over the line-delimited JSON
...
struct CoreClient {
    ...
    static func corePath() -> String {
        if let helper = Bundle.main.url(forResource: "bureaucratpdf-core", withExtension: nil, subdirectory: "Helpers") {
            return helper.path
        }
        let bundleHelper = Bundle.main.bundleURL
            .appendingPathComponent("Contents/Helpers/bureaucratpdf-core")
        ...
        let dev = URL(fileURLWithPath: FileManager.default.currentDirectoryPath)
            .appendingPathComponent("../core/target/release/bureaucratpdf-core")
        return dev.path
    }
    ...
    func request(_ json: [String: Any]) throws -> [String: Any] {
        ...
        env["BUREAUCRATPDF_WORK"] = workDir.path
